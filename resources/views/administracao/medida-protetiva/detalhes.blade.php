...
<section class="admin-panel measure-detail">
    ...
    <section class="measure-occurrences">
        <h2>Ocorrências:</h2>
        <div class="measure-occurrences-empty">
            Ocorrências ainda não disponíveis.
        </div>
    </section>
</section>
<div class="victim-detail-footer">
    <p id="measure-preview-note">Prévia visual. Nenhuma medida selecionada.</p>
    <button type="button" disabled aria-describedby="measure-preview-note">
        download PDF
