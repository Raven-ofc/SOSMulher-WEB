...
use App\Http\Controllers\Admin\TornozeleiraController;
...
Route::prefix('administracao')->name('admin.')->group(function () {
    ...
    Route::get('/tornozeleiras', [TornozeleiraController::class, 'index'])
        ->name('tornozeleiras.index');

    Route::get('/tornozeleiras/adicionar', [TornozeleiraController::class, 'create'])
        ->name('tornozeleiras.criar');

    Route::post('/tornozeleiras', [TornozeleiraController::class, 'store'])
        ->name('tornozeleiras.salvar');

    Route::get('/tornozeleiras/{tornozeleira}', [TornozeleiraController::class, 'show'])
        ->name('tornozeleiras.visualizar');

    Route::get('/tornozeleiras/{tornozeleira}/editar', [TornozeleiraController::class, 'edit'])
        ->name('tornozeleiras.editar');

    Route::put('/tornozeleiras/{tornozeleira}', [TornozeleiraController::class, 'update'])
        ->name('tornozeleiras.atualizar');

    Route::delete('/tornozeleiras/{tornozeleira}', [TornozeleiraController::class, 'destroy'])
        ->name('tornozeleiras.remover');
