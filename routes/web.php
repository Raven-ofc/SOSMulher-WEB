...
Route::view('/esqueci-senha', 'autenticacao.esqueci-senha')->name('senha.solicitar');
Route::post('/esqueci-senha', [SenhaController::class, 'email'])->middleware('throttle:5,1')->name('senha.email');
Route::get('/email-enviado', [SenhaController::class, 'enviado'])->name('senha.email.enviado');
Route::get('/redefinir-senha', [SenhaController::class, 'editar'])->name('senha.redefinir');
Route::post('/redefinir-senha', [SenhaController::class, 'atualizar'])->middleware('throttle:5,1')->name('senha.atualizar');
